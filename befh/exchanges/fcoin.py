...
class ExchGwApiFcoinWs(WebSocketApiClient):
    """
    Exchange Socket
    """
    ...
    def __init__(self):
        ...
        Constructor
        """
        WebSocketApiClient.__init__(self, 'ExchApiFcoin')
    ...
    @classmethod
    def get_link(cls):
        return 'wss://api.fcoin.com/v2/ws'
    ...
    def get_trades_subscription_string(cls, instmt):
        return json.dumps({"cmd": "sub", "args": ["trade.%s" % instmt.instmt_code]})
...
class ExchGwFcoin(ExchangeGateway):
    """
    Exchange gateway
    """
    def __init__(self, db_clients):
        ...
        """
        ExchangeGateway.__init__(self, ExchGwApiFcoinWs(), db_clients)
